...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><img src="../pics/logo_icon.png" alt="logo" width="20px" height="20px"> Page Analytics</b></h5>
  </header>

  <hr>
  <div class="w3-container">
    <h5>Page Tracking</h5>
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white" id="pagestableid">
