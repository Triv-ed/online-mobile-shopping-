        ...
        <div class="main1-container">
            <div class="title1">
              ...
              <div class="form-group">
                <div class="phone">
                  <input type="tel" class="form-control"  pattern="[7-9]{1}[0-9]{9}" required maxlength="10" required title="Must start with 7 to 9 and the length should be 10">    
                  <label for="mn" class="mn">Mobile Number *</label>    
                </div>
              </div>
              
              <div>
                <button type="submit" class="log-button">Continue</button>
              </div>
      
        <div>
            <label for="signup using" class="or">or sign up using</label>
        </div>
